...
def drawData(data,colorArray):
        ...
        for i,height in enumerate(normalised_data):
              ...
              canvas.create_text(x0+2,y0,anchor=SW,text=str(data[i]),font=("new roman",15,"italic bold"), fill="#05897A")
...
randon_generate=Button(root,text="Generate",bg="#2DAE9A",font=("arial",12,"italic bold"),relief=SUNKEN,activebackground="#05945B",activeforeground="white",bd=5,width=10,command=Generate)
randon_generate.place(x=750,y=60)
...
minvalue=Scale(root,from_=0,to=10,resolution=1,orient=HORIZONTAL,font=("arial",12,"italic bold"),relief=GROOVE,bd=2,width=10)
...
maxvalue=Scale(root,from_=0,to=100,resolution=1,orient=HORIZONTAL,font=("arial",12,"italic bold"),relief=GROOVE,bd=2,width=10)
...
speedscale=Scale(root,from_=0.1,to=5.0,resolution=0.2,length=200,digits=2,orient=HORIZONTAL,font=("arial",12,"italic bold"),relief=GROOVE,bd=2,width=10)
